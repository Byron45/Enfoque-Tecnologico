          ...
          <aside className="grid grid-rows-[auto_1fr_auto] gap-4 min-h-0">
            <div className="bg-white/5 border border-white/10 backdrop-blur-2xl rounded-[2rem] p-5">
              ...
              <p className="text-sm text-white/75 font-semibold leading-relaxed">
                Observa el escenario, recuerda los consejos tácticos y completa la evaluación para subir al Nivel 5.
              </p>
            </div>
            ...
            >
              {loading ? 'Actualizando nivel...' : isCompleted ? <><CheckCircle2 size={18} />Nivel 5 desbloqueado</> : <><PlayCircle size={18} />Iniciar evaluación</>}
            </motion.button>
          </aside>
        </div>
      </section>
